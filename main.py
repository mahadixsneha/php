...
DOMAIN           = os.getenv("DOMAIN", "https://phpbot.onrender.com")
MONGO_URI        = os.getenv("MONGO_URI", "mongodb+srv://user:pass@cluster.mongodb.net/phpbot?retryWrites=true&w=majority")
